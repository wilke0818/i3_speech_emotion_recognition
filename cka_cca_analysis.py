#The following functions were taken from https://colab.research.google.com/drive/1tvL-_rAY6uYPGLrcdSFJoaFG1mkOZkud?usp=sharing#scrollTo=INkjQ-H8riJe
...
#Start of speech emotion recognition specific code
...
def calculate_cka_cca(wav_files_path, model1_path, model2_path):
  ...
  for file in tqdm(wav_files, desc='Loading Wav Files...'):
    ...
    if audio.shape[0] > 1:
     audios.append(torch.mean(audio, 0)) 
    else:
